package com.SoulMen.base.security;

import com.SoulMen.base.entity.PO.AdminUserDetails;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.csrf()// 由于使用的是JWT，我们这里不需要csrf
                ...
                .permitAll()
                .antMatchers("/loginController/login", "/loginController/register")// 对登录注册要允许匿名访问
                .permitAll()
                .antMatchers(HttpMethod.OPTIONS)//跨域请求会先进行一次options请求
                .permitAll()
//                .antMatchers("/user/selectUserOne").hasRole("ADMIN")
